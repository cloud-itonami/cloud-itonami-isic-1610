# Operator Quickstart — Sawmilling and planing of wood

Shortest path from clone to a verified local dry-run for **ISIC 1610** (`cloud-itonami-isic-1610`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1610.git
cd cloud-itonami-isic-1610
```
...
- Blueprint governor key: `sawmill-plant-operations-governor`
- Likely source path: `sawmilling.governor.cljc`
