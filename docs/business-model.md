# Business Model: Sawmilling and planing of wood
...
## Classification
- Repository: `cloud-itonami-isic-1610` ([github.com/cloud-itonami/cloud-itonami-isic-1610](https://github.com/cloud-itonami/cloud-itonami-isic-1610))
- ISIC Rev.5: `1610` — Sawmilling and planing of wood
- Domain: `:wood-products/sawmilling`
- Social impact: :worker-safety :local-economy :resource-efficiency
- Actor: `:sawmill-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :wood-products/sawmilling — who wants
...
One managed tenant (:wood-products/sawmilling):
...
- Do not bypass the `:sawmill-plant-operations-governor` for production decisions.
