(ns sawmilling.phase
  "Phase 0->3 staged rollout for the sawmill plant-operations
  coordination actor.
  ...
  consequence (a saw-blade/planer/kiln maintenance window means
  production downtime, and the equipment ends up actually touched);
  it is always a human plant supervisor's call.
  `sawmilling.governor`'s `kiln-finalize-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Sawmill Plant Operations Governor verdict to a base
